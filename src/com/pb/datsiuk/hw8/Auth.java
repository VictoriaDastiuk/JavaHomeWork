package com.pb.datsiuk.hw8;
import com.pb.datsiuk.hw8.WrongLoginException;
import com.pb.datsiuk.hw8.WrongPasswordException;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
public abstract class Auth extends JFrame implements ActionListener {
        ...
        public void signUp(ActionEvent ae) {
            try {
                signIn(login.getText(), password.getText(), confirmPassword.getText(), "[\\w]{1,20}");
